<template>
  <div>
    <div class="row justify-between items-center" id="table-before-row">
      <div class="col-4">
        <span id="table-title" v-if="data.length > 0">
    ...
    >
      <template v-slot:body="props">
        ...
        >
          ...
          <q-td key="DtVerifikacije" :props="props"> </q-td>
          <q-td key="StatusVerifikacije" :props="props"> </q-td>
          ...
          <q-td key="actions" :props="props">
            <q-btn
              ...
              color="cro-gray"
              text-color="black"
              :icon="NTDetails ? 'keyboard_arrow_up' : 'keyboard_arrow_down'"
              @click="NTDetails = !NTDetails"
        ...
        >
          ...
          <q-td key="actions" :props="props">
            <q-btn
              ...
              color="cro-gray"
              text-color="black"
              :icon="PosParDetails ? 'keyboard_arrow_up' : 'keyboard_arrow_down'"
              @click="PosParDetails = !PosParDetails"
              v-if="data.length > 0 && data[0].EZSOPrivolitve.length > 2"
            />
          </q-td>
        </q-tr>
        ...
        >
          ...
          <q-td key="DtVerifikacije" :props="props">
            {{ props.row.DtVerifikacije }}
          </q-td>
          <q-td key="StatusVerifikacije" :props="props">
            {{ props.row.StatusVerifikacije }}
          </q-td>
          <q-td key="Vir" :props="props">
            {{ props.row.Vir }}
          </q-td>
          ...
          <q-td key="actions" :props="props">
            <q-btn
              ...
              size="12px"
              color="cro-gray"
              :icon="ESoglasjaDetails ? 'keyboard_arrow_up' : 'keyboard_arrow_down'"
              text-color="black"
              v-if="1 === 2"
              @click="ESoglasjaDetails = !ESoglasjaDetails"
            />
          </q-td>
        </q-tr>
      </template>
